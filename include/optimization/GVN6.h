...
class GVN : public Pass {
  public:
    ...
    std::shared_ptr<GVNExpression::PhiExpression> valuePhiFunc(Instruction * instr, BasicBlock *bb_ptr, std::shared_ptr<GVNExpression::Expression>,
                                                               const partitions &);
    ...
    std::shared_ptr<GVNExpression::Expression> fold_constant1(Instruction * instr, std::shared_ptr<GVNExpression::Expression> ve, const partitions & P);
